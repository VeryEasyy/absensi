...
<head>
    ...
    <title>Data Pengajuan Izin & Sakit</title>
    <style>
        .table tr td{
            font-size: 13px;
            text-align: center;
  ...
  <div class="page-body" style="margin-left: 15px">
    <div class="container-xxl">
        <div class="row">
            <div class="col-12">
                <form action="/absensi/datapengajuan" method="GET" autocomplete="off">
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-2">
                                ...
                                <input  type="text" id="tgl" name="tgl" value="{{Request('tgl') }}" class="form-control" placeholder="Tanggal Absensi " autocomplete="off">   
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <div class="d-flex align-items-center">
                                <div class="input-icon flex-grow-1">
                                    ...
                                    <input type="text" value="{{ Request('nuptk') }}" name="nuptk" class="form-control" placeholder="NUPTK">
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                @elseif(is_null($p->status_approved) || $p->status_approved == 0)
                                    <span class="badge bg-warning" style="color: black;">Pending</span>
                                @endif
                            </td>
                            <td>
                                @if ($p->status_approved == 0 )
                                    <a href="#" class="btn btn-sm btn-primary" id="approve" id_izinsakit="{{ $p->id }}">
                                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-external-link"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6" /><path d="M11 13l9 -9" /><path d="M15 4h5v5" /></svg>
                                        Konfirmasi
                                    </a>
                                @else
                                <a href="/absensi/{{ $p->id }}/batalizinsakit" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center">
