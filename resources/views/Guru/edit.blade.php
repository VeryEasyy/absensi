<form action="/guru/{{ $guru->nuptk }}/update" method="POST" id="formguru">
    @csrf
    <div class="input-icon mb-3">
        ...
        <input type="text" name="nuptk" id="nuptk" value="{{ $guru->nuptk }}" class="form-control" placeholder="NUPTK" autocomplete="off">
    </div>
    <div class="input-icon mb-3">
        <span class="input-icon-addon">
                <!-- Download SVG icon from http://tabler-icons.io/i/user -->
        ...
        <input type="text" name="nama" id="nama" value="{{ $guru->nama }}" class="form-control" placeholder="Username" autocomplete="off">
    </div>
    <div class="input-icon mb-3">
        <span class="input-icon-addon">
                <!-- Download SVG icon from http://tabler-icons.io/i/user -->
        ...
        <input type="text" name="jabatan" id="jabatan" value="{{ $guru->jabatan }}" class="form-control" placeholder="Jabatan" autocomplete="off">
    </div>
    <div class="input-icon mb-3">
        <span class="input-icon-addon">
                <!-- Download SVG icon from http://tabler-icons.io/i/user -->
        ...
        <input type="text" name="no_hp" id="np_hp" value="{{ $guru->no_hp }}" class="form-control" placeholder="No HP" autocomplete="off">
    </div>
    <div class="row mt-2">
        <div class="col-12">
